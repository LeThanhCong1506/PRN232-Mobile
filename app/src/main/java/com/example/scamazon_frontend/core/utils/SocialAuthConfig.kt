...
object SocialAuthConfig {
    ...
    // Register this exact URL in GitHub OAuth App → Authorization callback URL.
    const val GITHUB_REDIRECT_URI = "https://prn232-backend-production.up.railway.app/api/auth/github/callback"
}
